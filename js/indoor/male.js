var male = [
    ...
    },
    {
        ...
        "title":"Croquet",
        "content": "Croquet is a sport that involves hitting wooden or plastic balls with a mallet through hoops embedded in a grass playing court. Its international governing body is the World Croquet Federation.",
        "href": "Croquet.html"
    },
    {
        "img": "image/horseshoe.jpg",
        "title":"Horseshoes game",
        "content": "Horseshoes is a lawn game played between two people (or two teams of two people) using four horseshoes and two throwing targets (stakes) set in a lawn or sandbox area",
        "href": "Horseshoes.html"
    },
    {
        "img": "image/Cornhole.jpg",
        "title":"Cornhole",
        "content": "Cornhole (also known regionally as bags, sack toss, or bean bag toss) is a lawn game popular in North America in which players or teams take turns throwing fabric bean bags at a raised",
        "href":"Cornhol.html"
    }
]
