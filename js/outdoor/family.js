var family = [
    ...
    },
    {
        ...
        "content": "Capture the flag is a traditional outdoor sport where two or more teams each have a flag and the objective is to capture the other team's flag, located at the team's base.",
        "href": "Capture the flag.html"
    },
    {
        "img": "image/Three-legged race.jfif",
        "title":"Three-Legged Race",
        "content": "A three-legged race is a running event involving pairs of participants running with the left leg of one runner strapped to the right leg of another runner.",
    ...
    },
    {
        ...
        "title":"Tetherball",
        "content": "Tetherball is a game where two players use their hands to strike a volleyball which is suspended from a stationary metal pole by a rope or tether. The two players stand on opposite sides of the pole,",
